...
location = '/mnt/e/2019/'  # /mnt/c/teszt/rib/ C:/teszt/rib/
bz2_dir = 'jinx/'
txt_dir = 'rib_jinx_txt/'
fib_dir = 'rib_jinx_fib_format/'
...
def convert_to_fib_format(rib_txt_file):
	...
	with open(location + fib_dir + 'kesz_' + rib_txt_file, 'w') as f:
		for i in out_list:
			f.write(str(i) + '\n')
...
def bz2_to_fib(rib_bz2_file):
	...
	print('Process ID: {0} \t at: {1} started convert the file: {2}'.format(proc, datetime.datetime.now(), rib_bz2_file))
